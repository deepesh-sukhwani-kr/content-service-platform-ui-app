export enum EndPoints {
  ...
  ADD_ENDPOINT = '/imp/ui/v2/server/addImage',
  IMAGE_RETRIEVAL_ENDPOINT = 'https://impcoremgtdev.cfcdcinternaltest.kroger.com/imp/asset/v2/images/',
  //IMAGE_RETRIEVAL_ENDPOINT = 'https://impmgt.kroger.com/imp/asset/v1/images/',
  //VENDOR_SEARCH_ENDPOINT = 'http://localhost:8080/imp/ui/v1/server/vendorSearch'
  VENDOR_SEARCH_ENDPOINT = '/imp/ui/v1/server/vendorSearch'
}
