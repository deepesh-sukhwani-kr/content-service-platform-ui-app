export enum CsvUploadConstants {
  ...
  UPLOAD_STATUS_REPORT_FORMAT = 'File Provided,Upload Status,Image ID,FILE_NAME,GTIN,VIEW_ANGLE,SIZE,BACKGROUND,LAST_MODIFIED_DT,DESCRIPTION,UPC_10,UPC_12,UPC_13,SOURCE,IMAGE_TYPE,COLOR_PROFILE\r\n'
}
